...
| **Week 2** | **Prompt Engineering & Logic** | 🚧 *Upcoming: Resume Analyzer Tool* | *In Progress* |
| **Week 3** | **RAG & Embeddings** | ⏳ *TBD* | *Planned* |
| **Week 4** | **AI Economics & Strategy** | ⏳ *TBD* | *Planned* |
| **Month 5** | **Capstone Project** | 🏆 **The Document Chatbot** (End-to-End App) | *Planned* |
